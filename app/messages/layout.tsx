...
export default function MessagesLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="fixed inset-0 top-20 md:top-24 z-40 flex flex-col md:flex-row bg-background md:h-[calc(100vh-140px)] h-[calc(100dvh-80px)] md:w-full md:max-w-7xl md:mx-auto md:glass-card md:rounded-4xl md:overflow-hidden md:border md:border-white/40 shadow-2xl">
      {/* Sidebar (List) */}
